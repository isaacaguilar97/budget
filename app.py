...
# Get total amount
m_left = round(filtered_df.Balance.sum().item(),2)
...
col1, col2, col3 = st.columns([1, 2, 1]) # Adjust the ratios as needed

with col3: # Place the metric in the middle column
    # Display the total amount of money left from the Variables
    st.metric(label="Total Money Left", value=m_left)